...
public class AddFloatingActionButton extends FloatingActionButton {
  ...
  void init(Context context, AttributeSet attributeSet) {
    TypedArray attr = context.obtainStyledAttributes(attributeSet, com.example.splitexpense.R.styleable.AddFloatingActionButton, 0, 0);
    mPlusColor = attr.getColor(com.example.splitexpense.R.styleable.AddFloatingActionButton_fab_plusIconColor, getColor(android.R.color.white));
    attr.recycle();
